...
export const heroes: Hero[] = [
  // ========== 射手（发育路）- ADC (19名) ==========
  { id: 'houyi', name: '后羿', nameEn: 'Hou Yi', pinyin: 'hou yi', role: ['marksman'], color: roleColors, image: heroImages.houyi },
  { id: 'luban7', name: '鲁班七号', nameEn: 'Luban No.7', nickname: '鲁班', pinyin: 'lu ban qi hao', role: ['marksman'], color: roleColors, image: heroImages.luban7 },
  { id: 'sunshangxiang', name: '孙尚香', nameEn: 'Sun Shangxiang', nickname: '大小姐', pinyin: 'sun shang xiang', role: ['marksman'], color: roleColors, image: heroImages.sunshangxiang },
  { id: 'makeboluo', name: '马可波罗', nameEn: 'Marco Polo', pinyin: 'ma ke bo luo', role: ['marksman'], color: roleColors, image: heroImages.makeboluo },
  { id: 'direnjie', name: '狄仁杰', nameEn: 'Di Renjie', pinyin: 'di ren jie', role: ['marksman'], color: roleColors, image: heroImages.direnjie },
  { id: 'yuji', name: '虞姬', nameEn: 'Yu Ji', pinyin: 'yu ji', role: ['marksman'], color: roleColors, image: heroImages.yuji },
  { id: 'liyuanfang', name: '李元芳', nameEn: 'Li Yuanfang', pinyin: 'li yuan fang', role: ['marksman'], color: roleColors, image: heroImages.liyuanfang },
  { id: 'gongsunli', name: '公孙离', nameEn: 'Gongsun Li', nickname: '阿离', pinyin: 'gong sun li', role: ['marksman'], color: roleColors, image: heroImages.gongsunli },
  { id: 'jailuo', name: '伽罗', nameEn: 'Jialuo', pinyin: 'jia luo', role: ['marksman'], color: roleColors, image: heroImages.jailuo },
  { id: 'bailishouyue', name: '百里守约', nameEn: 'Baili Shouyue', pinyin: 'bai li shou yue', role: ['assassin', 'marksman'], color: roleColors, image: heroImages.bailishouyue },
  { id: 'huangzhong', name: '黄忠', nameEn: 'Huang Zhong', pinyin: 'huang zhong', role: ['marksman'], color: roleColors, image: heroImages.huangzhong },
  { id: 'ailin', name: '艾琳', nameEn: 'Ailin', pinyin: 'ai lin', role: ['marksman'], color: roleColors, image: heroImages.ailin },
  { id: 'mengya', name: '蒙犽', nameEn: 'Meng Ya', pinyin: 'meng ya', role: ['marksman'], color: roleColors, image: heroImages.mengya },
  { id: 'gaya', name: '戈娅', nameEn: 'Ga Ya', pinyin: 'ge ya', role: ['marksman'], color: roleColors, image: heroImages.gaya },
  { id: 'aoyin', name: '敖隐', nameEn: 'Ao Yin', pinyin: 'ao yin', role: ['marksman'], color: roleColors, image: heroImages.aoyin },
  { id: 'agudo', name: '阿古朵', nameEn: 'A Gu Duo', pinyin: 'a gu duo', role: ['marksman'], color: roleColors, image: heroImages.agudo },
  { id: 'cang', name: '苍', nameEn: 'Cang', pinyin: 'cang', role: ['marksman'], color: roleColors, image: heroImages.cang },
  { id: 'sunquan', name: '孙权', nameEn: 'Sun Quan', pinyin: 'sun quan', role: ['marksman'], color: roleColors, image: heroImages.sunquan },
  { id: 'laixiao', name: '莱西奥', nameEn: 'La Xiao', pinyin: 'lai xi ao', role: ['marksman'], color: roleColors, image: heroImages.laixiao },
  { id: 'yuanliuzhizi_archer', name: '元流之子(射手)', nameEn: 'Source Child (Archer)', pinyin: 'yuan liu zhi zi she shou', role: ['marksman'], color: roleColors, image: heroImages.yuanliuzhizi_archer },

  // ========== 辅助（游走）- Support (13名) ==========
  { id: 'zhuangzhou', name: '庄周', nameEn: 'Zhuang Zhou', nickname: '鱼', pinyin: 'zhuang zhou', role: ['tank', 'support'], color: roleColors, image: heroImages.zhuangzhou },
  { id: 'caiwenji', name: '蔡文姬', nameEn: 'Cai Wenji', pinyin: 'cai wen ji', role: ['mage', 'support'], color: roleColors, image: heroImages.caiwenji },
  { id: 'mingshiyin', name: '明世隐', nameEn: 'Ming Shiyin', pinyin: 'ming shi yin', role: ['mage', 'support'], color: roleColors, image: heroImages.mingshiyin },
  { id: 'yao', name: '瑶', nameEn: 'Yao', pinyin: 'yao', role: ['mage', 'support'], color: roleColors, image: heroImages.yao },
  { id: 'guiguzi', name: '鬼谷子', nameEn: 'Gui Gu Zi', pinyin: 'gui gu zi', role: ['mage', 'support'], color: roleColors, image: heroImages.guiguzi },
  { id: 'sunbin', name: '孙膑', nameEn: 'Sun Bin', pinyin: 'sun bin', role: ['mage', 'support'], color: roleColors, image: heroImages.sunbin },
  { id: 'daqiao', name: '大乔', nameEn: 'Da Qiao', pinyin: 'da qiao', role: ['mage', 'support'], color: roleColors, image: heroImages.daqiao },
  { id: 'sangqi', name: '桑启', nameEn: 'Sang Qi', pinyin: 'sang qi', role: ['mage', 'support'], color: roleColors, image: heroImages.sangqi },
  { id: 'duoliya', name: '朵莉亚', nameEn: 'Dolia', pinyin: 'duo li ya', role: ['mage', 'support'], color: roleColors, image: heroImages.duoliya },
  { id: 'shaosiyuan', name: '少司缘', nameEn: 'Shao Siyuan', pinyin: 'shao si yuan', role: ['mage', 'support'], color: roleColors, image: heroImages.shaosiyuan },
  { id: 'kongkonger', name: '空空儿', nameEn: 'Kong Kong Er', pinyin: 'kong kong er', role: ['fighter', 'support'], color: roleColors, image: heroImages.kongkonger },
  { id: 'yuanliuzhizi_support', name: '元流之子(辅助)', nameEn: 'Source Child (Support)', pinyin: 'yuan liu zhi zi fu zhu', role: ['support'], color: roleColors, image: heroImages.yuanliuzhizi_support },
  { id: 'mozi', name: '墨子', nameEn: 'Mo Zi', nickname: '和平守望', pinyin: 'mo zi', role: ['fighter', 'mage'], color: roleColors, image: heroImages.mozi },

  // ========== 坦克（对抗路/野区）- Tank (20名) ==========
  { id: 'niumo', name: '牛魔', nameEn: 'Niu Mo', pinyin: 'niu mo', role: ['tank', 'support'], color: roleColors, image: heroImages.niumo },
  { id: 'zhangfei', name: '张飞', nameEn: 'Zhang Fei', pinyin: 'zhang fei', role: ['tank', 'support'], color: roleColors, image: heroImages.zhangfei },
  { id: 'donghuangtaiyi', name: '东皇太一', nameEn: 'Dong Huang Tai Yi', pinyin: 'dong huang tai yi', role: ['mage', 'support'], color: roleColors, image: heroImages.donghuangtaiyi },
  { id: 'lianpo', name: '廉颇', nameEn: 'Lian Pin', pinyin: 'lian po', role: ['tank'], color: roleColors, image: heroImages.lianpo },
  { id: 'sulie', name: '苏烈', nameEn: 'Su Lie', pinyin: 'su lie', role: ['tank', 'support'], color: roleColors, image: heroImages.sulie },
  { id: 'dunshan', name: '盾山', nameEn: 'Dun Shan', pinyin: 'dun shan', role: ['tank', 'support'], color: roleColors, image: heroImages.dunshan },
  { id: 'zhongkui', name: '钟馗', nameEn: 'Zhong Kui', pinyin: 'zhong kui', role: ['tank', 'support'], color: roleColors, image: heroImages.zhongkui },
  { id: 'baiqi', name: '白起', nameEn: 'Bai Qi', pinyin: 'bai qi', role: ['tank'], color: roleColors, image: heroImages.baiqi },
  { id: 'liushan', name: '刘禅', nameEn: 'Liu Shan', pinyin: 'liu shan', role: ['tank', 'support'], color: roleColors, image: heroImages.liushan },
  { id: 'taiyizhenren', name: '太乙真人', nameEn: 'Taiyi Zhenren', pinyin: 'tai yi zhen ren', role: ['tank', 'support'], color: roleColors, image: heroImages.taiyizhenren },
  { id: 'sunce', name: '孙策', nameEn: 'Sun Ce', pinyin: 'sun ce', role: ['tank', 'fighter'], color: roleColors, image: heroImages.sunce },
  { id: 'lubandashi', name: '鲁班大师', nameEn: 'Luban Master', pinyin: 'lu ban da shi', role: ['tank', 'support'], color: roleColors, image: heroImages.lubandashi },
  { id: 'zhubajie', name: '猪八戒', nameEn: 'Zhu Bajie', pinyin: 'zhu ba jie', role: ['tank'], color: roleColors, image: heroImages.zhubajie },
  { id: 'dayu', name: '大禹', nameEn: 'Da Yu', pinyin: 'da yu', role: ['tank', 'support'], color: roleColors, image: heroImages.dayu },
  { id: 'mengqi', name: '梦奇', nameEn: 'Meng Qi', pinyin: 'meng qi', role: ['tank', 'mage'], color: roleColors, image: heroImages.mengqi },
  { id: 'liubang', name: '刘邦', nameEn: 'Liu Bang', nickname: '双面君主', pinyin: 'liu bang', role: ['tank', 'mage'], color: roleColors, image: heroImages.liubang },
  { id: 'chengyaojin', name: '程咬金', nameEn: 'Cheng Yaojin', pinyin: 'cheng yao jin', role: ['tank'], color: roleColors, image: heroImages.chengyaojin },
  { id: 'xiangyu', name: '项羽', nameEn: 'Xiang Yu', pinyin: 'xiang yu', role: ['tank', 'fighter'], color: roleColors, image: heroImages.xiangyu },
  { id: 'yadianna', name: '雅典娜', nameEn: 'Athena', pinyin: 'ya dian na', role: ['fighter', 'assassin'], color: roleColors, image: heroImages.yadianna },

  // ========== 法师（中路）- Mage (26名) ==========
  { id: 'daji', name: '妲己', nameEn: "Da Ji", pinyin: 'da ji', role: ['mage'], color: roleColors, image: heroImages.daji },
  { id: 'wuzetian', name: '武则天', nameEn: 'Wu Zetian', pinyin: 'wu ze tian', role: ['mage'], color: roleColors, image: heroImages.wuzetian },
  { id: 'zhenji', name: '甄姬', nameEn: 'Zhen Ji', pinyin: 'zhen ji', role: ['mage'], color: roleColors, image: heroImages.zhenji },
  { id: 'anqila', name: '安琪拉', nameEn: 'Angela', pinyin: 'an qi la', role: ['mage'], color: roleColors, image: heroImages.anqila },
  { id: 'wangzhaojun', name: '王昭君', nameEn: 'Wang Zhaojun', pinyin: 'wang zhao jun', role: ['mage'], color: roleColors, image: heroImages.wangzhaojun },
  { id: 'zhangliang', name: '张良', nameEn: 'Zhang Liang', pinyin: 'zhang liang', role: ['mage'], color: roleColors, image: heroImages.zhangliang },
  { id: 'gaojianli', name: '高渐离', nameEn: 'Gao Jianli', pinyin: 'gao jian li', role: ['mage'], color: roleColors, image: heroImages.gaojianli },
  { id: 'bianque', name: '扁鹊', nameEn: 'Bian Que', pinyin: 'bian que', role: ['fighter', 'mage'], color: roleColors, image: heroImages.bianque },
  { id: 'zhugeliang', name: '诸葛亮', nameEn: 'Zhuge Liang', pinyin: 'zhu ge liang', role: ['mage'], color: roleColors, image: heroImages.zhugeliang },
  { id: 'nvwa', name: '女娲', nameEn: "Nü Wa", pinyin: 'nv wa', role: ['mage'], color: roleColors, image: heroImages.nvwa },
  { id: 'diaochan', name: '貂蝉', nameEn: 'Diao Chan', pinyin: 'diao chan', role: ['mage'], color: roleColors, image: heroImages.diaochan },
  { id: 'buzhihuowu', name: '不知火舞', nameEn: 'Shiranui', pinyin: 'bu zhi huo wu', role: ['assassin', 'mage'], color: roleColors, image: heroImages.buzhihuowu },
  { id: 'yixing', name: '弈星', nameEn: 'Yi Xing', pinyin: 'yi xing', role: ['mage'], color: roleColors, image: heroImages.yixing },
  { id: 'milaidi', name: '米莱狄', nameEn: 'milaidi', pinyin: 'mi lai di', role: ['mage'], color: roleColors, image: heroImages.milaidi },
  { id: 'ganjiangmoye', name: '干将莫邪', nameEn: 'Ganjiang Moye', pinyin: 'gan jiang mo ye', role: ['mage'], color: roleColors, image: heroImages.ganjiangmoye },
  { id: 'shenmengxi', name: '沈梦溪', nameEn: 'Shen Mengxi', pinyin: 'shen meng xi', role: ['mage'], color: roleColors, image: heroImages.shenmengxi },
  { id: 'xishi', name: '西施', nameEn: 'Xi Shi', pinyin: 'xi shi', role: ['mage'], color: roleColors, image: heroImages.xishi },
  { id: 'shangguanwaner', name: '上官婉儿', nameEn: "Shangguan Wan'er", pinyin: 'shang guan wan er', role: ['mage'], color: roleColors, image: heroImages.shangguanwaner },
  { id: 'yingzheng', name: '嬴政', nameEn: 'Ying Zheng', pinyin: 'ying zheng', role: ['mage'], color: roleColors, image: heroImages.yingzheng },
  { id: 'zhouyu', name: '周瑜', nameEn: 'Zhou Yu', pinyin: 'zhou yu', role: ['fighter', 'mage'], color: roleColors, image: heroImages.zhouyu },
  { id: 'yangyuhuan', name: '杨玉环', nameEn: 'Yang Yuhuan', pinyin: 'yang yu huan', role: ['mage'], color: roleColors, image: heroImages.yangyuhuan },
  { id: 'jiangziya', name: '姜子牙', nameEn: 'Jiang Ziya', pinyin: 'jiang zi ya', role: ['mage'], color: roleColors, image: heroImages.jiangziya },
  { id: 'change', name: '嫦娥', nameEn: "Chang'e", pinyin: 'chang e', role: ['fighter', 'mage'], color: roleColors, image: heroImages.change },
  { id: 'jinchan', name: '金蝉', nameEn: 'Jin Chan', pinyin: 'jin chan', role: ['mage'], color: roleColors, image: heroImages.jinchan },
  { id: 'haiyue', name: '海月', nameEn: 'Hai Yue', pinyin: 'hai yue', role: ['mage'], color: roleColors, image: heroImages.haiyue },
  { id: 'hainuo', name: '海诺', nameEn: 'Hai Nuo', pinyin: 'hai nuo', role: ['mage'], color: roleColors, image: heroImages.hainuo },
  { id: 'yuanliuzhizi_magic', name: '元流之子(法师)', nameEn: 'Source Child (Mage)', pinyin: 'yuan liu zhi zi fa shi', role: ['mage'], color: roleColors, image: heroImages.yuanliuzhizi_magic },
  { id: 'xiaoqiao', name: '小乔', nameEn: 'Xiao Qiao', nickname: '恋之微风', pinyin: 'xiao qiao', role: ['mage'], color: roleColors, image: heroImages.xiaoqiao },
  { id: 'yase', name: '亚瑟', nameEn: 'Arthur', pinyin: 'ya se', role: ['tank', 'fighter'], color: roleColors, image: heroImages.yase },
  { id: 'hanxin', name: '韩信', nameEn: 'Han Xin', pinyin: 'han xin', role: ['assassin'], color: roleColors, image: heroImages.hanxin },
  { id: 'luna', name: '露娜', nameEn: 'Luna', pinyin: 'lu na', role: ['assassin', 'mage'], color: roleColors, image: heroImages.luna },
  { id: 'libai', name: '李白', nameEn: 'Li Bai', pinyin: 'li bai', role: ['assassin'], color: roleColors, image: heroImages.libai },
  { id: 'liubei', name: '刘备', nameEn: 'Liu Bei', pinyin: 'liu bei', role: ['fighter'], color: roleColors, image: heroImages.liubei },
  { id: 'dianwei', name: '典韦', nameEn: 'Dian Wei', pinyin: 'dian wei', role: ['fighter'], color: roleColors, image: heroImages.dianwei },
  { id: 'ake', name: '阿轲', nameEn: "A Ke", pinyin: 'a ke', role: ['assassin'], color: roleColors, image: heroImages.ake },
  { id: 'lanlingwang', name: '兰陵王', nameEn: 'Lanling Wang', pinyin: 'lan ling wang', role: ['assassin'], color: roleColors, image: heroImages.lanlingwang },
  { id: 'nakelulu', name: '娜可露露', nameEn: 'Nakoruru', pinyin: 'na ke lu lu', role: ['assassin'], color: roleColors, image: heroImages.nakelulu },
  { id: 'miyue', name: '芈月', nameEn: 'Mi Yue', pinyin: 'mi yue', role: ['mage'], color: roleColors, image: heroImages.miyue },
  { id: 'bailixuance', name: '百里玄策', nameEn: 'Baili Xuance', pinyin: 'bai li xuan ce', role: ['assassin'], color: roleColors, image: heroImages.bailixuance },
  { id: 'peiqinhu', name: '裴擒虎', nameEn: 'Pei Qinhu', pinyin: 'pei qin hu', role: ['assassin'], color: roleColors, image: heroImages.peiqinhu },
  { id: 'simayi', name: '司马懿', nameEn: 'Sima Yi', pinyin: 'si ma yi', role: ['assassin', 'mage'], color: roleColors, image: heroImages.simayi },
  { id: 'yunzhongjun', name: '云中君', nameEn: 'Yun Zhongjun', pinyin: 'yun zhong jun', role: ['assassin'], color: roleColors, image: heroImages.yunzhongjun },
  { id: 'lan', name: '澜', nameEn: 'Lan', pinyin: 'lan', role: ['fighter', 'assassin'], color: roleColors, image: heroImages.lan },
  { id: 'pangu', name: '盘古', nameEn: 'Pan Gu', pinyin: 'pan gu', role: ['fighter'], color: roleColors, image: heroImages.pangu },
  { id: 'jing', name: '镜', nameEn: 'Jing', pinyin: 'jing', role: ['assassin'], color: roleColors, image: heroImages.jing },
  { id: 'fei', name: '暃', nameEn: 'Fei', pinyin: 'fei', role: ['assassin'], color: roleColors, image: heroImages.fei },
  { id: 'yuanliuzhizi_assassin', name: '元流之子(刺客)', nameEn: 'Source Child (Assassin)', pinyin: 'yuan liu zhi zi ci ke', role: ['assassin'], color: roleColors, image: heroImages.yuanliuzhizi_assassin },
  { id: 'yao_fighter', name: '曜', nameEn: 'Yao', pinyin: 'yao', role: ['fighter', 'assassin'], color: roleColors, image: heroImages.yao_fighter },
  { id: 'zhaoyun', name: '赵云', nameEn: 'Zhao Yun', nickname: '苍天翔龙', pinyin: 'zhao yun', role: ['fighter', 'assassin'], color: roleColors, image: heroImages.zhaoyun },

  // ========== 对抗路（边路）- Fighter (25名) ==========
  { id: 'lvbu', name: '吕布', nameEn: "Lu Bu", pinyin: 'lv bu', role: ['tank', 'fighter'], color: roleColors, image: heroImages.lvbu },
  { id: 'machao', name: '马超', nameEn: 'Ma Chao', pinyin: 'ma chao', role: ['fighter'], color: roleColors, image: heroImages.machao },
  { id: 'guanyu', name: '关羽', nameEn: 'Guan Yu', pinyin: 'guan yu', role: ['tank', 'fighter'], color: roleColors, image: heroImages.guanyu },
  { id: 'huamulan', name: '花木兰', nameEn: 'Hua Mulan', pinyin: 'hua mu lan', role: ['fighter'], color: roleColors, image: heroImages.huamulan },
  { id: 'laofuzi', name: '老夫子', nameEn: 'Lao Fu Zi', pinyin: 'lao fu zi', role: ['fighter'], color: roleColors, image: heroImages.laofuzi },
  { id: 'kuangtie', name: '狂铁', nameEn: 'Kuang Tie', pinyin: 'kuang tie', role: ['tank', 'fighter'], color: roleColors, image: heroImages.kuangtie },
  { id: 'xiahoudun', name: '夏侯惇', nameEn: 'Xiahou Dun', pinyin: 'xia hou dun', role: ['tank', 'fighter'], color: roleColors, image: heroImages.xiahoudun },
  { id: 'xialuote', name: '夏洛特', nameEn: 'Charlotte', pinyin: 'xia luo te', role: ['fighter'], color: roleColors, image: heroImages.xialuote },
  { id: 'mengtian', name: '蒙恬', nameEn: 'Meng Tian', pinyin: 'meng tian', role: ['tank', 'fighter'], color: roleColors, image: heroImages.mengtian },
  { id: 'yuange', name: '元歌', nameEn: 'Yuan Ge', pinyin: 'yuan ge', role: ['assassin'], color: roleColors, image: heroImages.yuange },
  { id: 'jvyoujing', name: '橘右京', nameEn: 'Tachibana Ukyo', pinyin: 'ju you jing', role: ['fighter', 'assassin'], color: roleColors, image: heroImages.jvyoujing },
  { id: 'jixiaoman', name: '姬小满', nameEn: 'Ji Xiaoman', pinyin: 'ji xiao man', role: ['fighter'], color: roleColors, image: heroImages.jixiaoman },
  { id: 'yalian', name: '亚连', nameEn: 'A Lian', pinyin: 'ya lian', role: ['tank', 'fighter'], color: roleColors, image: heroImages.yalian },
  { id: 'sikongzhen', name: '司空震', nameEn: 'Si Kong Zhen', pinyin: 'si kong zhen', role: ['fighter', 'mage'], color: roleColors, image: heroImages.sikongzhen },
  { id: 'damo', name: '达摩', nameEn: 'Damo', pinyin: 'da mo', role: ['tank', 'fighter'], color: roleColors, image: heroImages.damo },
  { id: 'kai', name: '铠', nameEn: 'Kai', pinyin: 'kai', role: ['tank', 'fighter'], color: roleColors, image: heroImages.kai },
  { id: 'sunwukong', name: '孙悟空', nameEn: 'Sun Wukong', pinyin: 'sun wu kong', role: ['assassin'], color: roleColors, image: heroImages.sunwukong },
  { id: 'gongbenwuzang', name: '宫本武藏', nameEn: 'Miyamoto Musashi', pinyin: 'gong ben wu zang', role: ['fighter', 'assassin'], color: roleColors, image: heroImages.gongbenwuzang },
  { id: 'yangjian', name: '杨戬', nameEn: 'Yang Jian', pinyin: 'yang jian', role: ['fighter'], color: roleColors, image: heroImages.yangjian },
  { id: 'nezha', name: '哪吒', nameEn: 'Nezha', pinyin: 'ne zha', role: ['tank', 'fighter'], color: roleColors, image: heroImages.nezha },
  { id: 'caocao', name: '曹操', nameEn: 'Cao Cao', pinyin: 'cao cao', role: ['fighter'], color: roleColors, image: heroImages.caocao },
  { id: 'zhongwuyan', name: '钟无艳', nameEn: 'Zhong Wuyan', pinyin: 'zhong wu yan', role: ['tank', 'fighter'], color: roleColors, image: heroImages.zhongwuyan },
  { id: 'lixin', name: '李信', nameEn: 'Li Xin', pinyin: 'li xin', role: ['fighter'], color: roleColors, image: heroImages.lixin },
  { id: 'zhaohuaizhen', name: '赵怀真', nameEn: 'Zhao Huaizhen', pinyin: 'zhao huai zhen', role: ['fighter'], color: roleColors, image: heroImages.zhaohuaizhen },
  { id: 'chicha', name: '蚩奼', nameEn: 'Chi Yan', pinyin: 'chi yan', role: ['fighter'], color: roleColors, image: heroImages.chicha },
  { id: 'dasiming', name: '大司命', nameEn: 'Da Siming', pinyin: 'da si ming', role: ['fighter'], color: roleColors, image: heroImages.dasiming },
