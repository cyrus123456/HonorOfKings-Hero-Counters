...
const heroImages: Record<HeroId, string> = {
  ...
  lianpin: `https://game.gtimg.cn/images/yxzj/img201606/heroimg/105/105.jpg`,             // 廉颇 105
  ...
  // ========== 法师（中路）- Mage ==========
  shangguwaner: `https://game.gtimg.cn/images/yxzj/img201606/heroimg/513/513.jpg`,       // 上官婉儿 513
  ...
  milady: `https://game.gtimg.cn/images/yxzj/img201606/heroimg/504/504.jpg`,              // 米莱狄 504
  ...
  nuwa: `https://game.gtimg.cn/images/yxzj/img201606/heroimg/179/179.jpg`,                // 女娲 179
  ...
  kai_jg: `https://game.gtimg.cn/images/yxzj/img201606/heroimg/193/193.jpg`,              // 铠 193
  ...
  yase_jg: `https://game.gtimg.cn/images/yxzj/img201606/heroimg/166/166.jpg`,             // 亚瑟 166
  ...
  juyoujing_jg: `https://game.gtimg.cn/images/yxzj/img201606/heroimg/163/163.jpg`,         // 橘右京(打野) 163
  gongben: `https://game.gtimg.cn/images/yxzj/img201606/heroimg/130/130.jpg`,             // 宫本武藏 130
  mengqi_jg: `https://game.gtimg.cn/images/yxzj/img201606/heroimg/198/198.jpg`,           // 梦奇 198
  ...
  yao2: `https://game.gtimg.cn/images/yxzj/img201606/heroimg/522/522.jpg`,                 // 曜 522
  ...
  juyoujing_bl: `https://game.gtimg.cn/images/yxzj/img201606/heroimg/163/163.jpg`,         // 橘右京(边路) 163
  jixiaoman: `https://game.gtimg.cn/images/yxzj/img201606/heroimg/564/564.jpg`,            // 姬小满 564
  alian: `https://game.gtimg.cn/images/yxzj/img201606/heroimg/514/514.jpg`,               // 亚连 514
  ...
  ying2: `https://game.gtimg.cn/images/yxzj/img201606/heroimg/558/558.jpg`,               // 影 558
  yunying: `https://game.gtimg.cn/images/yxzj/img201606/heroimg/538/538.jpg`,             // 云缨 538
  yuanliuzhizi: `https://game.gtimg.cn/images/yxzj/img201606/heroimg/581/581.jpg`,         // 源流之子(坦克) 581
};

// 英雄数据 - 基于王者荣耀官方130名英雄（截至2026年4月）
export const heroes: Hero[] = [
  // ========== 射手（发育路）- ADC (19名) ==========
  { id: 'houyi', name: '后羿', nameEn: 'Hou Yi', role: 'adc', color: '#3b82f6', image: heroImages.houyi },
  { id: 'luban7', name: '鲁班七号', nameEn: 'Luban No.7', nickname: '鲁班', role: 'adc', color: '#3b82f6', image: heroImages.luban7 },
  { id: 'sunshangxiang', name: '孙尚香', nameEn: 'Sun Shangxiang', nickname: '大小姐', role: 'adc', color: '#3b82f6', image: heroImages.sunshangxiang },
  { id: 'makeboluo', name: '马可波罗', nameEn: 'Marco Polo', role: 'adc', color: '#3b82f6', image: heroImages.makeboluo },
  { id: 'direnjie', name: '狄仁杰', nameEn: 'Di Renjie', role: 'adc', color: '#3b82f6', image: heroImages.direnjie },
  { id: 'yuji', name: '虞姬', nameEn: 'Yu Ji', role: 'adc', color: '#3b82f6', image: heroImages.yuji },
  { id: 'liyuanfang', name: '李元芳', nameEn: 'Li Yuanfang', role: 'adc', color: '#3b82f6', image: heroImages.liyuanfang },
  { id: 'gongsunli', name: '公孙离', nameEn: 'Gongsun Li', nickname: '阿离', role: 'adc', color: '#3b82f6', image: heroImages.gongsunli },
  { id: 'jailuo', name: '伽罗', nameEn: 'Jialuo', role: 'adc', color: '#3b82f6', image: heroImages.jailuo },
  { id: 'bailishouyue', name: '百里守约', nameEn: 'Baili Shouyue', nickname: '守约', role: 'adc', color: '#3b82f6', image: heroImages.bailishouyue },
  { id: 'huangzhong', name: '黄忠', nameEn: 'Huang Zhong', role: 'adc', color: '#3b82f6', image: heroImages.huangzhong },
  { id: 'ailin', name: '艾琳', nameEn: 'Ailin', role: 'adc', color: '#3b82f6', image: heroImages.ailin },
  { id: 'mengya', name: '蒙犽', nameEn: 'Meng Ya', role: 'adc', color: '#3b82f6', image: heroImages.mengya },
  { id: 'gaya', name: '戈娅', nameEn: 'Ga Ya', role: 'adc', color: '#3b82f6', image: heroImages.gaya },
  { id: 'aoyin', name: '敖隐', nameEn: 'Ao Yin', role: 'adc', color: '#3b82f6', image: heroImages.aoyin },
  { id: 'agudo', name: '阿古朵', nameEn: 'A Gu Duo', role: 'adc', color: '#3b82f6', image: heroImages.agudo }, // 官方主分类为射手
  { id: 'cang', name: '苍', nameEn: 'Cang', role: 'adc', color: '#3b82f6', image: heroImages.cang },
  { id: 'sunquan', name: '孙权', nameEn: 'Sun Quan', role: 'adc', color: '#3b82f6', image: heroImages.sunquan },
  { id: 'laixiao', name: '莱西奥', nameEn: 'La Xiao', role: 'adc', color: '#3b82f6', image: heroImages.laixiao },
  { id: 'yuanliuzhizi_archer', name: '元流之子(射手)', nameEn: 'Source Child (Archer)', role: 'adc', color: '#3b82f6', image: heroImages.yuanliuzhizi_archer },

  // ========== 辅助（游走）- Support (29名) ==========
  { id: 'zhuangzhou', name: '庄周', nameEn: 'Zhuang Zhou', nickname: '鱼', role: 'support', color: '#22c55e', image: heroImages.zhuangzhou },
  { id: 'niumo', name: '牛魔', nameEn: 'Niu Mo', role: 'support', color: '#22c55e', image: heroImages.niumo },
  { id: 'zhangfei', name: '张飞', nameEn: 'Zhang Fei', role: 'support', color: '#22c55e', image: heroImages.zhangfei },
  { id: 'donghuangtaiyi', name: '东皇太一', nameEn: 'Dong Huang Tai Yi', role: 'support', color: '#22c55e', image: heroImages.donghuangtaiyi },
  { id: 'caiwenji', name: '蔡文姬', nameEn: 'Cai Wenji', role: 'support', color: '#22c55e', image: heroImages.caiwenji },
  { id: 'mingshiyin', name: '明世隐', nameEn: 'Ming Shiyin', role: 'support', color: '#22c55e', image: heroImages.mingshiyin },
  { id: 'yao', name: '瑶', nameEn: 'Yao', role: 'support', color: '#22c55e', image: heroImages.yao },
  { id: 'lianpin', name: '廉颇', nameEn: 'Lian Pin', role: 'support', color: '#22c55e', image: heroImages.lianpin },
  { id: 'sulie', name: '苏烈', nameEn: 'Su Lie', role: 'support', color: '#22c55e', image: heroImages.sulie },
  { id: 'guiguzi', name: '鬼谷子', nameEn: 'Gui Gu Zi', role: 'support', color: '#22c55e', image: heroImages.guiguzi },
  { id: 'dunshan', name: '盾山', nameEn: 'Dun Shan', role: 'support', color: '#22c55e', image: heroImages.dunshan },
  { id: 'zhongkui', name: '钟馗', nameEn: 'Zhong Kui', role: 'support', color: '#22c55e', image: heroImages.zhongkui },
  { id: 'baiqi', name: '白起', nameEn: 'Bai Qi', role: 'support', color: '#22c55e', image: heroImages.baiqi },
  { id: 'liushan', name: '刘禅', nameEn: 'Liu Shan', role: 'support', color: '#22c55e', image: heroImages.liushan },
  { id: 'sunbin', name: '孙膑', nameEn: 'Sun Bin', role: 'support', color: '#22c55e', image: heroImages.sunbin },
  { id: 'taiyizhenren', name: '太乙真人', nameEn: 'Taiyi Zhenren', role: 'support', color: '#22c55e', image: heroImages.taiyizhenren },
  { id: 'daqiao', name: '大乔', nameEn: 'Da Qiao', role: 'support', color: '#22c55e', image: heroImages.daqiao },
  { id: 'sunce', name: '孙策', nameEn: 'Sun Ce', role: 'support', color: '#22c55e', image: heroImages.sunce },
  { id: 'lubandashi', name: '鲁班大师', nameEn: 'Luban Master', role: 'support', color: '#22c55e', image: heroImages.lubandashi },
  { id: 'zhubajie', name: '猪八戒', nameEn: 'Zhu Bajie', role: 'support', color: '#22c55e', image: heroImages.zhubajie },
  { id: 'sangqi', name: '桑启', nameEn: 'Sang Qi', role: 'support', color: '#22c55e', image: heroImages.sangqi },
  { id: 'duoliya', name: '朵莉亚', nameEn: 'Dolia', role: 'support', color: '#22c55e', image: heroImages.duoliya },
  { id: 'shaosiyuan', name: '少司缘', nameEn: 'Shao Siyuan', role: 'support', color: '#22c55e', image: heroImages.shaosiyuan },
  { id: 'kongkonger', name: '空空儿', nameEn: 'Kong Kong Er', role: 'support', color: '#22c55e', image: heroImages.kongkonger },
  ...
  { id: 'dayu', name: '大禹', nameEn: 'Da Yu', role: 'support', color: '#22c55e', image: heroImages.dayu },
  { id: 'mozi', name: '墨子', nameEn: 'Mo Zi', nickname: '和平守望', role: 'support', color: '#22c55e', image: heroImages.mozi },
  ...
  { id: 'bianque', name: '扁鹊', nameEn: 'Bian Que', role: 'mage', color: '#a855f7', image: heroImages.bianque },
  { id: 'zhugeliang', name: '诸葛亮', nameEn: 'Zhuge Liang', role: 'mage', color: '#a855f7', image: heroImages.zhugeliang },
  { id: 'nuwa', name: '女娲', nameEn: "Nü Wa", role: 'mage', color: '#a855f7', image: heroImages.nuwa },
  { id: 'diaochan', name: '貂蝉', nameEn: 'Diao Chan', role: 'mage', color: '#a855f7', image: heroImages.diaochan },
  { id: 'buzhihuowu', name: '不知火舞', nameEn: 'Shiranui', role: 'mage', color: '#a855f7', image: heroImages.buzhihuowu },
  { id: 'yixing', name: '弈星', nameEn: 'Yi Xing', role: 'mage', color: '#a855f7', image: heroImages.yixing },
  { id: 'milady', name: '米莱狄', nameEn: 'Milady', role: 'mage', color: '#a855f7', image: heroImages.milady },
  ...
  { id: 'shangguwaner', name: '上官婉儿', nameEn: "Shangguan Wan'er", role: 'mage', color: '#a855f7', image: heroImages.shangguwaner },
  { id: 'yingzheng', name: '嬴政', nameEn: 'Ying Zheng', role: 'mage', color: '#a855f7', image: heroImages.yingzheng },
  { id: 'zhouyu', name: '周瑜', nameEn: 'Zhou Yu', role: 'mage', color: '#a855f7', image: heroImages.zhouyu },
  ...
  { id: 'change', name: '嫦娥', nameEn: "Chang'e", role: 'mage', color: '#a855f7', image: heroImages.change },
  ...
  { id: 'yase_jg', name: '亚瑟', nameEn: 'Arthur', role: 'jungle', color: '#f97316', image: heroImages.yase_jg },
  { id: 'sunwukong', name: '孙悟空', nameEn: 'Sun Wukong', role: 'jungle', color: '#f97316', image: heroImages.sunwukong },
  { id: 'hanxin', name: '韩信', nameEn: 'Han Xin', role: 'jungle', color: '#f97316', image: heroImages.hanxin },
  { id: 'luna', name: '露娜', nameEn: 'Luna', role: 'jungle', color: '#f97316', image: heroImages.luna },
  { id: 'libai', name: '李白', nameEn: 'Li Bai', role: 'jungle', color: '#f97316', image: heroImages.libai },
  { id: 'liubei', name: '刘备', nameEn: 'Liu Bei', role: 'jungle', color: '#f97316', image: heroImages.liubei },
  { id: 'dianwei', name: '典韦', nameEn: 'Dian Wei', role: 'jungle', color: '#f97316', image: heroImages.dianwei },
  { id: 'ake', name: '阿轲', nameEn: "A Ke", role: 'jungle', color: '#f97316', image: heroImages.ake },
  { id: 'lanlingwang', name: '兰陵王', nameEn: 'Lanling Wang', role: 'jungle', color: '#f97316', image: heroImages.lanlingwang },
  { id: 'nakelulu', name: '娜可露露', nameEn: 'Nakoruru', role: 'jungle', color: '#f97316', image: heroImages.nakelulu },
  { id: 'gongben', name: '宫本武藏', nameEn: 'Miyamoto Musashi', role: 'jungle', color: '#f97316', image: heroImages.gongben },
  { id: 'miyue', name: '芈月', nameEn: 'Mi Yue', role: 'jungle', color: '#f97316', image: heroImages.miyue },
  { id: 'kai_jg', name: '铠', nameEn: 'Kai', role: 'jungle', color: '#f97316', image: heroImages.kai_jg },
  { id: 'bailixuance', name: '百里玄策', nameEn: 'Baili Xuance', role: 'jungle', color: '#f97316', image: heroImages.bailixuance },
  { id: 'peiqinhu', name: '裴擒虎', nameEn: 'Pei Qinhu', role: 'jungle', color: '#f97316', image: heroImages.peiqinhu },
  { id: 'simayi', name: '司马懿', nameEn: 'Sima Yi', role: 'jungle', color: '#f97316', image: heroImages.simayi },
  { id: 'yunzhongjun', name: '云中君', nameEn: 'Yun Zhongjun', role: 'jungle', color: '#f97316', image: heroImages.yunzhongjun },
  { id: 'lan', name: '澜', nameEn: 'Lan', role: 'jungle', color: '#f97316', image: heroImages.lan },
  { id: 'pangu', name: '盘古', nameEn: 'Pan Gu', role: 'jungle', color: '#f97316', image: heroImages.pangu },
  { id: 'jing', name: '镜', nameEn: 'Jing', role: 'jungle', color: '#f97316', image: heroImages.jing },
  { id: 'mengqi_jg', name: '梦奇', nameEn: 'Meng Qi', role: 'jungle', color: '#f97316', image: heroImages.mengqi_jg },
  { id: 'fei', name: '暃', nameEn: 'Fei', role: 'jungle', color: '#f97316', image: heroImages.fei },
  { id: 'yuanliuzhizi_assassin', name: '元流之子(刺客)', nameEn: 'Source Child (Assassin)', role: 'jungle', color: '#f97316', image: heroImages.yuanliuzhizi_assassin },
  { id: 'yao2', name: '曜', nameEn: 'Yao', role: 'jungle', color: '#f97316', image: heroImages.yao2 },
  { id: 'zhaoyun', name: '赵云', nameEn: 'Zhao Yun', nickname: '苍天翔龙', role: 'jungle', color: '#f97316', image: heroImages.zhaoyun },

  // ========== 对抗路（边路）- Toplane (31名) ==========
  { id: 'lvbu', name: '吕布', nameEn: "Lu Bu", role: 'toplane', color: '#ef4444', image: heroImages.lvbu },
  { id: 'machao', name: '马超', nameEn: 'Ma Chao', role: 'toplane', color: '#ef4444', image: heroImages.machao },
  { id: 'guanyu', name: '关羽', nameEn: 'Guan Yu', role: 'toplane', color: '#ef4444', image: heroImages.guanyu },
  { id: 'huamulan', name: '花木兰', nameEn: 'Hua Mulan', role: 'toplane', color: '#ef4444', image: heroImages.huamulan },
  { id: 'laofuzi', name: '老夫子', nameEn: 'Lao Fu Zi', role: 'toplane', color: '#ef4444', image: heroImages.laofuzi },
  { id: 'kuangtie', name: '狂铁', nameEn: 'Kuang Tie', role: 'toplane', color: '#ef4444', image: heroImages.kuangtie },
  { id: 'xiahoudun', name: '夏侯惇', nameEn: 'Xiahou Dun', role: 'toplane', color: '#ef4444', image: heroImages.xiahoudun },
  { id: 'xialuote', name: '夏洛特', nameEn: 'Charlotte', role: 'toplane', color: '#ef4444', image: heroImages.xialuote },
  { id: 'mengtian', name: '蒙恬', nameEn: 'Meng Tian', role: 'toplane', color: '#ef4444', image: heroImages.mengtian },
  { id: 'yuange', name: '元歌', nameEn: 'Yuan Ge', role: 'toplane', color: '#ef4444', image: heroImages.yuange },
  { id: 'juyoujing_bl', name: '橘右京', nameEn: 'Tachibana Ukyo', role: 'toplane', color: '#ef4444', image: heroImages.juyoujing_bl },
  { id: 'jixiaoman', name: '姬小满', nameEn: 'Ji Xiaoman', role: 'toplane', color: '#ef4444', image: heroImages.jixiaoman },
  { id: 'alian', name: '亚连', nameEn: 'A Lian', role: 'toplane', color: '#ef4444', image: heroImages.alian },
  { id: 'sikongzhen', name: '司空震', nameEn: 'Si Kong Zhen', role: 'toplane', color: '#ef4444', image: heroImages.sikongzhen },
  { id: 'damo', name: '达摩', nameEn: 'Damo', role: 'toplane', color: '#ef4444', image: heroImages.damo },
  { id: 'xiangyu', name: '项羽', nameEn: 'Xiang Yu', role: 'toplane', color: '#ef4444', image: heroImages.xiangyu },
  { id: 'chengyaojin', name: '程咬金', nameEn: 'Cheng Yaojin', role: 'toplane', color: '#ef4444', image: heroImages.chengyaojin },
  { id: 'yangjian', name: '杨戬', nameEn: 'Yang Jian', role: 'toplane', color: '#ef4444', image: heroImages.yangjian },
  { id: 'yadianna', name: '雅典娜', nameEn: 'Athena', role: 'toplane', color: '#ef4444', image: heroImages.yadianna },
  { id: 'nezha', name: '哪吒', nameEn: 'Nezha', role: 'toplane', color: '#ef4444', image: heroImages.nezha },
  { id: 'caocao', name: '曹操', nameEn: 'Cao Cao', role: 'toplane', color: '#ef4444', image: heroImages.caocao },
  { id: 'zhongwuyan', name: '钟无艳', nameEn: 'Zhong Wuyan', role: 'toplane', color: '#ef4444', image: heroImages.zhongwuyan },
  { id: 'lixin', name: '李信', nameEn: 'Li Xin', role: 'toplane', color: '#ef4444', image: heroImages.lixin },
  { id: 'zhaohuaizhen', name: '赵怀真', nameEn: 'Zhao Huaizhen', role: 'toplane', color: '#ef4444', image: heroImages.zhaohuaizhen },
  { id: 'chicha', name: '蚩奼', nameEn: 'Chi Yan', role: 'toplane', color: '#ef4444', image: heroImages.chicha },
  { id: 'dasiming', name: '大司命', nameEn: 'Da Siming', role: 'toplane', color: '#ef4444', image: heroImages.dasiming },
  { id: 'ying2', name: '影', nameEn: 'Ying', role: 'toplane', color: '#ef4444', image: heroImages.ying2 },
  { id: 'yunying', name: '云缨', nameEn: 'Yun Ying', role: 'toplane', color: '#ef4444', image: heroImages.yunying },
  { id: 'yuanliuzhizi', name: '源流之子(坦克)', nameEn: 'Source Child (Tank)', role: 'toplane', color: '#ef4444', image: heroImages.yuanliuzhizi },
  { id: 'liubang', name: '刘邦', nameEn: 'Liu Bang', nickname: '双面君主', role: 'toplane', color: '#ef4444', image: heroImages.liubang },
];
...
export const counterRelations: CounterRelation[] = [
  ...
  { source: 'lianpin', target: 'dunshan', strength: 2 },           // A: 廉颇
  ...
  // --- 鬼谷子 ---
  { source: 'lianpin', target: 'guiguzi', strength: 3 },            // S: 廉颇
  { source: 'zhuangzhou', target: 'guiguzi', strength: 2 },         // A: 庄周
  { source: 'donghuangtaiyi', target: 'guiguzi', strength: 2 },     // A: 东皇太一
  // 原因：怕霸体、怕解控、怕反手硬控

  // --- 廉颇（辅助）---
  { source: 'donghuangtaiyi', target: 'lianpin', strength: 3 },     // S: 东皇太一
  { source: 'zhangfei', target: 'lianpin', strength: 2 },           // A: 张飞
  // 原因：怕无视霸体的点名控制
  ...
  { source: 'lianpin', target: 'sunce', strength: 2 },               // A: 廉颇
  ...
  { source: 'lianpin', target: 'lubandashi', strength: 2 },           // A: 廉颇
  ...
  { source: 'mengqi_jg', target: 'zhubajie', strength: 3 },           // S: 梦奇
  ...
  { source: 'lianpin', target: 'kongkonger', strength: 2 },          // A: 廉颇
  ...
  // --- 上官婉儿 ---
  { source: 'zhangliang', target: 'shangguwaner', strength: 3 },    // S: 张良
  { source: 'daji', target: 'shangguwaner', strength: 2 },          // A: 妲己
  { source: 'yixing', target: 'shangguwaner', strength: 2 },        // A: 弈星
  // 原因：怕稳定硬控、怕起飞失败

  // --- 貂蝉 ---
  { source: 'shangguwaner', target: 'diaochan', strength: 3 },      // S: 上官婉儿
  ...
  // --- 甄姬 ---
  { source: 'milady', target: 'zhenji', strength: 3 },              // S: 米莱狄
  { source: 'buzhihuowu', target: 'zhenji', strength: 2 },          // A: 不知火舞
  // 原因：怕小兵/机器人挡弹射、怕突脸

  // --- 米莱狄 ---
  { source: 'gaojianli', target: 'milady', strength: 3 },           // S: 高渐离
  { source: 'wangzhaojun', target: 'milady', strength: 2 },          // A: 王昭君
  // 原因：怕强冲脸、怕AOE清场
  ...
  { source: 'shangguwaner', target: 'anqila', strength: 2 },          // A: 上官婉儿
  // 原因：怕多位移绕技能
  ...
  // --- 女娲 ---
  { source: 'shenmengxi', target: 'nuwa', strength: 3 },              // S: 沈梦溪
  { source: 'buzhihuowu', target: 'nuwa', strength: 2 },              // A: 不知火舞
  // 原因：怕持续远程消耗和突脸
  ...
  { source: 'shangguwaner', target: 'yingzheng', strength: 2 },        // A: 上官婉儿
  ...
  { source: 'shangguwaner', target: 'jiangziya', strength: 2 },        // A: 上官婉儿
  ...
  { source: 'shangguwaner', target: 'xiaoqiao', strength: 2 },         // A: 上官婉儿
  ...
  { source: 'yase_jg', target: 'luna', strength: 3 },                 // S: 亚瑟
  ...
  { source: 'kai_jg', target: 'sunwukong', strength: 2 },             // A: 铠
  // 原因：怕前中期硬拼、怕更高贴脸爆发

  // --- 刘备 ---
  { source: 'kai_jg', target: 'liubei', strength: 3 },                // S: 铠
  { source: 'jing', target: 'liubei', strength: 2 },                   // A: 镜
  // 原因：怕免伤和多段规避

  // --- 铠（打野）---
  { source: 'libai', target: 'kai_jg', strength: 3 },                 // S: 李白
  { source: 'luna', target: 'kai_jg', strength: 2 },                  // A: 露娜
  // 原因：怕拉扯骗大、怕不跟你正面

  // --- 李白 ---
  { source: 'hanxin', target: 'libai', strength: 3 },                 // S: 韩信
  { source: 'yase_jg', target: 'libai', strength: 2 },                // A: 亚瑟
  ...
  { source: 'kai_jg', target: 'hanxin', strength: 2 },                // A: 铠
  { source: 'yase_jg', target: 'hanxin', strength: 2 },               // A: 亚瑟
  // 原因：怕反甲+解控、怕容错低被抓失误
  ...
  // --- 亚瑟（打野）---
  { source: 'miyue', target: 'yase_jg', strength: 3 },                // S: 芈月
  { source: 'diaochan', target: 'yase_jg', strength: 2 },             // A: 貂蝉
  // 原因：怕持续吸血拉扯
  ...
  // --- 盘古 ---
  { source: 'juyoujing_bl', target: 'pangu', strength: 3 },           // S: 橘右京
  { source: 'jing', target: 'pangu', strength: 2 },                   // A: 镜
  // 原因：怕技能型打野，不怕你缴械

  // --- 橘右京 ---
  { source: 'gongben', target: 'juyoujing_bl', strength: 3 },         // S: 宫本武藏
  { source: 'jing', target: 'juyoujing_bl', strength: 2 },            // A: 镜
  // 原因：怕霸体压制、怕更高机动对拼

  // --- 宫本武藏 ---
  { source: 'mengqi_jg', target: 'gongben', strength: 3 },            // S: 梦奇
  { source: 'dianwei', target: 'gongben', strength: 2 },              // A: 典韦
  // 原因：怕高护盾厚度、怕贴脸硬拼

  // --- 梦奇（打野/边）---
  { source: 'jing', target: 'mengqi_jg', strength: 3 },               // S: 镜
  { source: 'lvbu', target: 'mengqi_jg', strength: 3 },               // S: 吕布
  { source: 'laofuzi', target: 'mengqi_jg', strength: 2 },            // A: 老夫子
  ...
  { source: 'yase_jg', target: 'yuanliuzhizi_assassin', strength: 2 },     // A: 亚瑟
  { source: 'dianwei', target: 'yuanliuzhizi_assassin', strength: 1 },     // B: 典韦
  // 原因：多段突进+多段伤害刺客，怕抗多段爆发英雄和稳定锁头控制

  // --- 曜 ---
  { source: 'donghuangtaiyi', target: 'yao2', strength: 3 },          // S: 东皇太一
  { source: 'zhangliang', target: 'yao2', strength: 3 },              // S: 张良
  { source: 'yase_jg', target: 'yao2', strength: 2 },                 // A: 亚瑟
  { source: 'dianwei', target: 'yao2', strength: 2 },                 // A: 典韦
  { source: 'kai_jg', target: 'yao2', strength: 1 },                  // B: 铠
  // 原因：怕回星前被控死，怕强行站场
  ...
  { source: 'lianpin', target: 'machao', strength: 3 },               // S: 廉颇
  ...
  { source: 'lianpin', target: 'laofuzi', strength: 3 },              // S: 廉颇
  ...
  // --- 关羽 ---
  { source: 'yuanliuzhizi', target: 'guanyu', strength: 3 },           // S: 源流之子
  { source: 'lianpin', target: 'guanyu', strength: 3 },               // S: 廉颇
  { source: 'xialuote', target: 'guanyu', strength: 2 },              // A: 夏洛特
  // 原因：怕连续控断马腿

  // --- 源流之子 ---
  { source: 'lvbu', target: 'yuanliuzhizi', strength: 3 },             // S: 吕布
  { source: 'xiahoudun', target: 'yuanliuzhizi', strength: 2 },        // A: 夏侯惇
  // 原因：怕真伤和更厚正面站场

  // --- 吕布 ---
  { source: 'juyoujing_bl', target: 'lvbu', strength: 3 },            // S: 橘右京
  { source: 'jixiaoman', target: 'lvbu', strength: 2 },               // A: 姬小满
  // 原因：怕灵活位移和技能拉扯

  // --- 橘右京（边）---
  { source: 'jixiaoman', target: 'juyoujing_bl', strength: 3 },       // S: 姬小满
  { source: 'alian', target: 'juyoujing_bl', strength: 2 },           // A: 亚连
  // 原因：怕多段抓取和硬拼

  // --- 姬小满 ---
  { source: 'alian', target: 'jixiaoman', strength: 3 },              // S: 亚连
  { source: 'xiahoudun', target: 'jixiaoman', strength: 2 },           // A: 夏侯惇
  // 原因：怕霸体和更稳定换血

  // --- 亚连 ---
  { source: 'sikongzhen', target: 'alian', strength: 3 },             // S: 司空震
  { source: 'lvbu', target: 'alian', strength: 2 },                   // A: 吕布
  // 原因：怕远程风筝和真伤
  ...
  { source: 'lianpin', target: 'damo', strength: 1 },                 // B: 廉颇
  ...
  { source: 'mengqi_jg', target: 'chengyaojin', strength: 3 },        // S: 梦奇
  ...
  // --- 影 ---
  { source: 'lvbu', target: 'ying2', strength: 3 },                   // S: 吕布
  { source: 'donghuangtaiyi', target: 'ying2', strength: 3 },         // S: 东皇太一
  { source: 'zhangliang', target: 'ying2', strength: 2 },             // A: 张良
  { source: 'xiahoudun', target: 'ying2', strength: 2 },              // A: 夏侯惇
  { source: 'laofuzi', target: 'ying2', strength: 1 },                // B: 老夫子
...
export const getRoleColor = (role: string): string => {
  switch (role) {
    case 'toplane': return '#ef4444';
    case 'mage': return '#a855f7';
    case 'jungle': return '#f97316';
...
export const getRoleName = (role: string, language: string = 'zh'): string => {
  const roleNames: Record<string, Record<string, string>> = {
    toplane: { zh: '对抗路', en: 'Top Lane', ja: 'トップレーン', ko: '탑', 'zh-TW': '對抗路', es: 'Suela', fr: 'Top', de: 'Top', pt: 'Topo', ru: 'Топ', it: 'Corridoia' },
    mage: { zh: '法师', en: 'Mage', ja: 'メイジ', ko: '미드', 'zh-TW': '法師', es: 'Mago', fr: 'Mage', de: 'Magier', pt: 'Mago', ru: 'Маг', it: 'Mago' },
    jungle: { zh: '打野', en: 'Jungle', ja: 'ジャングル', ko: '정글', 'zh-TW': '打野', es: 'Jungla', fr: 'Jungle', de: 'Dschungel', pt: 'Selva', ru: 'Лес', it: 'Selva' },
    adc: { zh: '射手', en: 'ADC/Marksman', ja: 'ADC', ko: '원딜', 'zh-TW': '射手', es: 'Tirador', fr: 'Tireur', de: 'Schütze', pt: 'Atirador', ru: 'АДК', it: 'Tiratore' },
