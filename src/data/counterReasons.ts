...
export const counterReasons: Record<string, CounterReasonData> = {
  ...
  // 卢雅那
  'luyana-yingzheng': {
    reasonZh: '卢雅那大招的致盲效果能够让嬴政大招随机偏移，大大降低其命中率',
    reasonEn: '卢雅那大招的致盲效果能够让嬴政大招随机偏移，大大降低其命中率'
  },
  'luyana-houyi': {
    reasonZh: '后羿依靠普通攻击进行输出，致盲效果完美克制后羿，同时卢雅那高机动性能够拉扯后羿',
    reasonEn: '后羿依靠普通攻击进行输出，致盲效果完美克制后羿，同时卢雅那高机动性能够拉扯后羿'
  },
  'ailin-luyana': {
    reasonZh: '艾琳的大招无法被致盲效果干扰，能够完全命中',
    reasonEn: '艾琳的大招无法被致盲效果干扰，能够完全命中'
  },
  'buzhihuowu-luyana': {
    reasonZh: '卢雅那缺少保命技能，在面对不知火舞的高爆发和多控制下难以反制',
    reasonEn: '卢雅那缺少保命技能，在面对不知火舞的高爆发和多控制下难以反制'
  },
  // 心魔六耳
  'xinmoliuer-houyi': {
    reasonZh: '后羿缺乏位移手段，心魔六耳可利用二技能快速逼近，一技能控制后打出完整连招，后羿难以反应逃脱',
    reasonEn: '后羿缺乏位移手段，心魔六耳可利用二技能快速逼近，一技能控制后打出完整连招，后羿难以反应逃脱'
  },
  'xinmoliuer-ganjiangmoye': {
    reasonZh: '心魔六耳的二技能切入距离超过干将莫邪的技能射程，大招无法选中期间可规避其飞剑伤害，反制效果较强',
    reasonEn: '心魔六耳的二技能切入距离超过干将莫邪的技能射程，大招无法选中期间可规避其飞剑伤害，反制效果较强'
  },
  'jinchan-xinmoliuer': {
    reasonZh: '金蝉的一技能对高机动性刺客威胁极大，被动锦襕宝衣可有效减免心魔六耳的多段伤害，大招蓄力阶段容易被金蝉控制打断',
    reasonEn: '金蝉的一技能对高机动性刺客威胁极大，被动锦襕宝衣可有效减免心魔六耳的多段伤害，大招蓄力阶段容易被金蝉控制打断'
  },
  'kai-xinmoliuer': {
    reasonZh: '心魔六耳的大招蓄力阶段可被铠的格挡效果大量削减输出，正面作战能力有限，铠的厚实血线也让心魔六耳难以快速击杀',
    reasonEn: '心魔六耳的大招蓄力阶段可被铠的格挡效果大量削减输出，正面作战能力有限，铠的厚实血线也让心魔六耳难以快速击杀'
  }
};
