...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    title: '王者荣耀英雄被克制关系图',
    subtitle: 'Honor of Kings Hero Counters - 谁克制我',
    allHeroes: '全部英雄',
    heroes: '英雄',
    tank: '坦克',
    fighter: '战士',
    ...
    multiSelectHint: '按住 Ctrl 多选英雄',
    networkFilter: '英雄分路筛选',
    networkFilterDesc: '节点网络图上方菜单可筛选对抗路/法师/打野/射手/辅助分路',
    mapType: '地图类型',
    ...
    tankBrief: '对抗路：单带、切后、前排',
    damageBrief: '法师：法伤、控制、消耗',
    supportBrief: '辅助：保护、开团、增益',
    ...
    addCounteredByRelation: '添加被克制关系',
    ...
    fullscreenTitle: '全屏体验',
    fullscreenMessage: '点击下方按钮进入全屏模式，获得更好的使用体验！英雄快速搜索框在屏幕底部',
    fullscreenButton: '进入全屏',
    fullscreenSkip: '跳过',
    pwaInstallTitle: '添加到主屏幕',
    pwaInstallMessage: '将此网页添加到主屏幕，可以获得类似原生应用的全屏体验！英雄快速搜索框在屏幕底部',
    pwaInstallButton: '了解如何添加',
    pwaInstallSkip: '跳过',
  },
  en: {
    title: 'Honor of Kings Hero Counter Relationships',
    ...
    multiSelectHint: 'Hold Ctrl to select multiple heroes',
    networkFilter: 'Hero Lane Filter',
    networkFilterDesc: 'Use the menu above the network graph to filter by Top/Mage/Jungle/ADC/Support lanes',
    mapType: 'Map Type',
    ...
    tankBrief: 'Top Lane: Split push, Dive, Frontline',
    damageBrief: 'Mage: Magic DMG, CC, Poke',
    supportBrief: 'Support: Peel, Engage, Buff',
    ...
    historySnapshotShort: 'Snapshots',
    ...
    addCounteredByRelation: 'Add Countered-By Relation',
    ...
    fullscreenTitle: 'Fullscreen Experience',
    fullscreenMessage: 'Tap the button below to enter fullscreen mode for a better experience! The hero quick search box is at the bottom of the screen',
    fullscreenButton: 'Enter Fullscreen',
    fullscreenSkip: 'Skip',
    pwaInstallTitle: 'Add to Home Screen',
    pwaInstallMessage: 'Add this page to your home screen for a native app-like fullscreen experience! The hero quick search box is at the bottom of the screen',
    pwaInstallButton: 'Learn How to Add',
    pwaInstallSkip: 'Skip',
  },
  ja: {
    title: 'オーバーチュア ヒーロー相性図',
    subtitle: 'Honor of Kings ヒーローカウンター チェッカー',
    allHeroes: '全ヒーロー',
    heroes: 'ヒーロー',
    tank: 'タンク',
    fighter: 'ファイター',
    ...
    multiSelectHint: 'Ctrlを押しながら複数ヒーロー選択',
  ...
  ko: {
    title: '오버워치 2 영웅 상성도',
    subtitle: 'Honor of Kings 영웅 카운터 관계',
    allHeroes: '전체 영웅',
    heroes: '영웅',
    tank: '탱커',
    fighter: '파이터',
    ...
    multiSelectHint: 'Ctrl 키를 눌러 여러 영웅 선택',
  ...
  'zh-TW': {
    title: '鬥陣特攻英雄被剋制關係圖',
    subtitle: 'Honor of Kings Hero Counters - 誰剋制我',
    allHeroes: '全部英雄',
    heroes: '英雄',
    tank: '坦克',
    fighter: '戰士',
  ...
  es: {
    title: 'Sobrecarga de Contadores de Héroes de Honor of Kings',
    ...
    multiSelectHint: 'Mantén Ctrl para seleccionar varios héroes',
    ...
    historySnapshotShort: 'Instantáneas',
  ...
  fr: {
    title: 'Relations de Contre des Héros Honor of Kings',
    ...
    multiSelectHint: 'Maintenez Ctrl pour sélectionner plusieurs héros',
    ...
    historySnapshotShort: 'Instantanés',
  ...
  de: {
    title: 'Honor of Kings Helden Gegenbeziehungen',
    ...
    multiSelectHint: 'Ctrl gedrückt halten für Mehrfachauswahl',
  ...
  pt: {
    title: 'Relações de Contra de Heróis Honor of Kings',
    ...
    multiSelectHint: 'Segure Ctrl para selecionar vários heróis',
    ...
    historySnapshotShort: 'Instantâneos',
  ...
  ru: {
    title: 'Отношения Контроу Героев Honor of Kings',
    ...
    multiSelectHint: 'Удерживайте Ctrl для выбора нескольких героев',
  ...
  it: {
    title: 'Relazioni di Contro degli Eroi Honor of Kings',
    ...
    multiSelectHint: 'Tieni premuto Ctrl per selezionare più eroi',
