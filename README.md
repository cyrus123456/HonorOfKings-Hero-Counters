...
# Honor of Kings Hero Counter Relationships

[**简体中文**](README.zh-CN.md) | English

An interactive visualization application built with React + TypeScript + Vite to display hero counter relationships and synergies in Honor of Kings.

## Live Demo

- **GitHub Pages**: [https://cyrus123456.github.io/HonorOfKings-Hero-Counters/](https://cyrus123456.github.io/HonorOfKings-Hero-Counters/)
- **Cloudflare Workers(国内可访问)**: [https://honorofkings-hero-counters.pages.dev/](https://honorofkings-hero-counters.pages.dev/)
...
- **Complete Hero Library**: All KOG heroes with role classifications (Tank, Damage, Support)
...
2. Each node represents an Honor of Kings hero
...
- [Honor of Kings Official](https://pvp.qq.com/)
...
**Note**: Honor of Kings and related resources are trademarks of Tencent Games.
